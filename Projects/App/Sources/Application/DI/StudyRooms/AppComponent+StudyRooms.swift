...
public extension AppComponent {
    ...
    var fehtchMyStudyRoomApplicationItemsUserCase: any FetchMyStudyRoomAppItemsUserCase {
        FehtchMyStudyRoomApplicationItemsUserCaseImpl(studyRoomsRepository: studyRoomsRepository)
    }
}
