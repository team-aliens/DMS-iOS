...
extension AppComponent: Registration {
    public func registerItems() {
        ...
        localTable["fetchListRemainApplicationItemsUseCase-any FetchListRemainApplicationItemsUseCase"] = { [unowned self] in self.fetchListRemainApplicationItemUseCase as Any }
